...
const BenefitsBlock = ({ benefits, className = "" }) => {
    ...
    return (
        <div className={`bg-[#13151A] p-6 sharp-border border border-white/5 ${className}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 bg-[#1C1F26] p-8 sharp-border border-t-4 border-[#FF4F00]">
            ...
            <div className="md:col-span-4 flex flex-col gap-6">
                <div className="sticky top-24 flex flex-col gap-6">
                    <div className="bg-[#13151A] p-4 flex items-center justify-center sharp-border relative">
                        <img src={productData.baseImage} alt={productData.name} className="max-h-[300px] w-auto object-contain will-change-transform" />
                        {isThermo && (
                            <div className="absolute top-4 left-4 bg-[#FF4F00] text-white text-xs font-bold px-2 py-1 uppercase tracking-widest sharp-border">
            ...
            <div className="md:col-span-8 flex flex-col">
                ...
                <div className="space-y-2 mb-8 p-6 bg-[#13151A] sharp-border border border-white/5">
                    <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-6 flex items-center gap-2">
                        ...
                        <div className="h-px bg-[#FF4F00] flex-grow ml-4"></div>
                    </h3>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 p-6 bg-[#13151A] sharp-border border border-white/5">
                    ...
                    <button disabled={!isValid} onClick={scrollToContact} className={`h-[56px] w-full sm:w-auto text-white px-8 uppercase font-bold text-sm tracking-widest transition-all duration-300 sharp-border flex items-center justify-center gap-3 group shrink-0 ${isValid ? 'bg-[#FF4F00] hover:bg-white hover:text-black orange-glow-hover' : 'bg-gray-600 cursor-not-allowed opacity-50'}`}>
                ...
                {!isValid && (
                    <div className="mt-2 flex items-center gap-2 text-red-400 text-xs mb-6 md:mb-0">
